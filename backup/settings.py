...
SECRET_KEY = '15esxb4jv6l%5_@!i^z=gkz-lq((jjf^0t1s_#0!3e$9f36koc'
...
USE_FILESYSTEM = "ext4" # ext4 or btrfs. btrfs supports faster mkfs, resize
DIRECTORIES_ROOT = "/srv/userbackup"
LVM_ROOT = "/dev/backupdisks"

# Set server hostname. Used in help messages. You can also change this to static one.
try:
    HOSTNAME = socket.gethostname()
except:
    HOSTNAME = 'localhost'

# Automatically add users (when creating storage) and delete users (when deleting storage)
...
try:
    ...
    print "Can't import local_settings. This is not fatal error."
    pass
